...
export default class Capture extends HTMLElement {
    ...
    takePhoto() {
        ...
        const ce = new CustomEvent(Capture.TAKE_PHOTO, { detail: this.model.sessionName ? this.model.sessionName : 'untitled', bubbles: true, composed: true });
    ...
    recordVideo() {
        ...
        const ce = new CustomEvent(Capture.RECORD_VIDEO, { detail: { recording: this.model.recording, name: this.model.sessionName ? this.model.sessionName : 'untitled' }, bubbles: true, composed: true });
        new EventBus().triggerEvent(ce);
        this.render();
    }
}
